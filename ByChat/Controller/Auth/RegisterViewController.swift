...
class RegisterViewController: UIViewController {
    ...
    private let signUpButton: UIButton = {
        ...
        button.setTitleColor(.chatPink, for: .normal)
    ...
    override func viewDidLoad() {
        ...
        configureUI()
        setGradient()
        validation = RegisterValidation(emailField: emailView.textFeild()!,
                                        passwordField: passwordView.textFeild()!,
                                        fullnameField: fullNameView.textFeild()!,
                                        usernameField: usernameView.textFeild()!,
                                        profileImage: avatarButton,
    ...
    @objc func handleSignUp() {
        ...
        let user = AuthCredentials(email: email,
                                   password: password,
                                   fullName: fullName,
                                   username: username,
                                   imageProfile: data)
        AuthService.shared.registerUser(user) { [weak self] error in
    ...
    //MARK: - Helpers
    func configureUI() {
        view.backgroundColor = .chatPink
        let stackView = UIStackView(arrangedSubviews: [emailView,passwordView,fullNameView,usernameView,signUpButton])
