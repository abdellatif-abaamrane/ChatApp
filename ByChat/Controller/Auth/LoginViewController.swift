...
class LoginViewController: UIViewController {
    ...
    private let logoImageView: UIImageView = {
        ...
        iv.image = #imageLiteral(resourceName: "chat logo")
        return iv
    }()
    ...
    override func viewDidLoad() {
        ...
        configureUI()
        setGradient()
        validation = Validation(emailField: emailView.textFeild()!,
    ...
    @objc func handleLogin() {
        guard let email = emailView.textFeild()?.text,
              let password = passwordView.textFeild()?.text else {
            return
        }
